                    ...
                    var _html = "";
                                $.each(data, function (i) {
                                    ...
                                    if (row.parentId == "0") {
                                        ...
                                        _html += '<a href="#">'
                                        _html += '<i class="fa fa-desktop"></i><span>' + row.name + '</span><i class="fa fa-angle-left pull-right"></i>'
                                        _html += '</a>'
                                        ...
                                        if (childNodes.length > 0) {
                                            ...
                                            $.each(childNodes, function (i) {
                                                ...
                                                if (subchildNodes.length > 0) {
                                                    _html += '<a href="#"><i class="fa fa-desktop"></i>' + subrow.name + '';
                                                    _html += '<i class="fa fa-angle-left pull-right"></i></a>';
                                                    _html += '<ul class="treeview-menu">';
                                                    $.each(subchildNodes, function (i) {
                                                        var subchildNodesrow = subchildNodes[i];
                                                        _html += '<li><a class="menuItem" data-id="' + subrow.id + '" href="' + subrow.href + '"><i class="fa fa-desktop"></i>' + subchildNodesrow.name + '</a></li>';
                                                    });
                                                    _html += '</ul>';

                                                } else {
                                                    _html += '<a class="menuItem" data-id="' + subrow.id + '" href="' + subrow.href + '"><i class="fa fa-desktop"></i>' + subrow.name + '</a>';
                                                }
                                                _html += '</li>';
                                            });
                                            _html += '</ul>';
